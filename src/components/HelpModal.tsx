                    ...
                    {topic === "treeType" ? (
                        <>
                            <div>
                                ...
                                <p>
                                    文字列の先頭から順に枝分かれして保存する基本的な木構造です。共通の接頭辞をまとめるため、。広がる形の盆栽栽に仕上がります。
                                </p>
                            </div>
                            <div>
                                ...
                                <p>
                                    1文字ずつの中間ノードを圧縮し、連続した文字列を1本のエッジとして保持します。樹木としての形状がよりコンパクトになります。
                                </p>
                            </div>
                            <div>
                                ...
                                <p>
                                    文字列のすべての接尾辞を格納する構造です。小さいサボテンの花を彷彿させる密集した形状になります。
                                </p>
                            </div>
                        </>
                    ) : (
