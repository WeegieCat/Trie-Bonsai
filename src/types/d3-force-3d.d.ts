declare module "d3-force-3d" {
    ...
    export interface Simulation<NodeDatum extends SimulationNodeDatum> {
        ...
        force<F extends Force<NodeDatum, any>>(name: string, force: F | null): this;
        find(x: number, y: number, z: number, radius?: number): NodeDatum | undefined;
        randomSource(): () => number;
        randomSource(source: () => number): this;
        on(typenames: string, listener: ((this: Simulation<NodeDatum>) => void) | null): this;
    }
    ...
    > extends Force<NodeDatum, LinkDatum> {
        ...
        id(): (node: NodeDatum, index: number, nodesData: NodeDatum[]) => string | number;
        id(id: (node: NodeDatum, index: number, nodesData: NodeDatum[]) => string | number): this;
